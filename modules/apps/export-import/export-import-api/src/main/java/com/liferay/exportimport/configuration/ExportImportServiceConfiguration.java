...
public interface ExportImportServiceConfiguration {
	...
	@Meta.AD(
		deflt = "0", description = "export-import-entry-expiration-days-help",
		name = "export-import-entry-expiration-days", required = false
	)
	public int exportImportEntryExpirationDays();
